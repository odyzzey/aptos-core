    ...
    pub fn zeros() -> Self {
        Self {
            ...
            ristretto255: cryptography::ristretto255::GasParameters {
                ...
                point_decompress_cost: 0,
                point_equals_cost: 0,
                point_from_64_uniform_bytes_cost: 0,
                point_identity_cost: 0,
                point_mul_cost: 0,
                point_neg_cost: 0,
                point_sub_cost: 0,
                scalar_add_cost: 0,
                scalar_from_256_bits_cost: 0,
                scalar_from_64_uniform_bytes_cost: 0,
                scalar_from_u128_cost: 0,
                scalar_from_u64_cost: 0,
                scalar_invert_cost: 0,
                scalar_is_canonical_cost: 0,
                scalar_mul_cost: 0,
                scalar_neg_cost: 0,
                sha512_per_byte_cost: 0,
                sha512_per_hash_cost: 0,
                scalar_sub_cost: 0,
            },
